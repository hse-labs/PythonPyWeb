...
class Author(models.Model):
    ...
    username = models.SlugField(verbose_name='Имя аккаунта',
                                help_text="Введите username, не длиннее 50 символов. Использовать нужно латинский алфавит, разделять фразы нужно символом '-'",
                                unique=True)
    ...
    self_esteem = models.DecimalField(max_digits=2, decimal_places=1,
                                      ...
                                      help_text="Введите уровень Вашей самооценки, только честно! Градация от 0 до 5 , где 0 -'я не совсем молодец, 5 - я умница",
                                      null=True,
                                      blank=True
                                      )
